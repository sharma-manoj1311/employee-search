...
public final class DTConstants {
    ...
    public static final String DT_PM_SEARCHTEXT = "searchText";
    public static final String DT_PM_FROM_DATE = "startDate";
    public static final String DT_PM_TO_DATE = "endDate";
