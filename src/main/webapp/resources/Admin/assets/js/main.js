...
(function(b) {
    ...
    b(function() {
        ...
        b(".todo--panel").on("submit", "form", function(a) {
            ...
            b('<li class="list-group-item" style="display: none;"><label class="todo--label"><input type="checkbox" name="" value="1" class="todo--input"><span class="todo--text">' +
                c.val() + '</span></label><a href="#" class="todo--remove">&times;</a></li>').appendTo(a.children(".list-group")).slideDown("slow");
            c.val("")
